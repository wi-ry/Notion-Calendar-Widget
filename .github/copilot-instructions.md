...
`npm run build` writes release output under `src-tauri/target/release/`, including NSIS and MSI installers under `bundle/` and the portable executable at `src-tauri/target/release/what-n-when.exe`.
